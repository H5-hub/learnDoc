import{_ as n,c as s,o as a,a as e}from"./app-DPzVS4bC.js";const i={},l=e(`<h2 id="电子签名组件" tabindex="-1"><a class="header-anchor" href="#电子签名组件"><span>电子签名组件</span></a></h2><ol><li>使用npm安装Signature Pad 在项目中使用npm安装Signature Pad库。</li></ol><ul><li><code>npm install signature_pad --save</code></li></ul><ol start="2"><li>引入Signature Pad 在Vue中可以使用import关键字将Signature Pad引入进来。</li></ol><ul><li><code>import SignaturePad from &#39;signature_pad&#39;;</code></li></ul><ol start="3"><li>使用Signature Pad创建一个绘制区域 在Vue的模板中创建一个canvas元素，用于用户在上面签名。</li></ol><div class="language-vue line-numbers-mode" data-highlighter="prismjs" data-ext="vue" data-title="vue"><pre><code><span class="line"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span></span>
...
<span class="line">        }</span>
<span class="line">      }).then(res =<span class="token entity named-entity" title="&gt;">&amp;gt;</span> {</span>
<span class="line">        console.log(res.data);</span>
<span class="line">      }).catch(err =<span class="token entity named-entity" title="&gt;">&amp;gt;</span> {</span>
...
<span class="line">  }</span>
<span class="line">};</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),t=[l];function p(c,d){return a(),s("div",null,t)}const u=n(i,[["render",p],["__file","index.html.vue"]]),v=JSON.parse('{"path":"/zh/advance/Signature/","title":"","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"电子签名组件","slug":"电子签名组件","link":"#电子签名组件","children":[]}],"git":{"updatedTime":1734335687000,"contributors":[{"name":"zp","email":"1429033948@qq.com","commits":1}]},"filePathRelative":"zh/advance/Signature/index.md"}');export{u as comp,v as data};
